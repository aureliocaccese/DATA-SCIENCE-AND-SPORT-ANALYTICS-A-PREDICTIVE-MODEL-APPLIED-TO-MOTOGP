# Nuovo script: predizione_probabilita_podio_gp_italia.py

Script migliorato per la predizione e visualizzazione della probabilità di podio al GP Italia per i piloti MotoGP, con grafici ottimizzati per la tesi.
